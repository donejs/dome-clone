# Contributing to ir-clone

## Developing Locally

This section will walk you through setting up the [repository](https://github.com//ir-clone) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork ir-clone, you can start by going to its [fork page](https://github.com//ir-clone/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/ir-clone
```
